//
//  EntrepreneurshipProjectPopularViewController.swift
//  WashingMachine
//
...
class EntrepreneurshipProjectPopularViewController: NCTableListViewController {
    ...
    override func viewDidLoad() {
        ...
        EntrepreneurshopPlanPopularCell.register(toTabeView: tableView)
    ...
    func loadPorject(_ loadWay: NCNetworkLoadWay) {
        ...
        NetworkEngine.get(api_get_cy_popularity + "1",
...
//MARK: --------------- tableView 代理相关 ------------------
extension EntrepreneurshipProjectPopularViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = EntrepreneurshopPlanPopularCell.create(tableView, indexPath) as! EntrepreneurshopPlanPopularCell
        
        cell.config(dataSource[indexPath.row] as! EntrepreneurshipPlan, indexPath)
