...
@interface PublickPlanViewController ()<UITextViewDelegate,SelectedImagesViewControllerDelegate>
{
    UIView *alpheView;
    UILabel *laber;
    CGFloat vertical;
...
@property(nonatomic , strong) UITextField *dispatchPrice;//价格
@property (nonatomic, strong) UITextField *cycle;//计量单位
@property (nonatomic, strong) UITextField *stock;//库存
@property (nonatomic, strong) UITextField *spec;//技术规格
...
@implementation PublickPlanViewController
...
-(void)makeUI {
    ...
    self.stock = [[UITextField alloc]init];
    self.stock.font = [UIFont systemFontOfSize:16];
    self.stock.textColor = UIColorFromRGB(0x666666);
    self.stock.placeholder = @"请输入";
    self.stock.keyboardType = UIKeyboardTypeNumberPad;
    self.stock.tag = 3;
    [self.stock addTarget:self action:@selector(textFieldDidChange:) forControlEvents:UIControlEventEditingChanged];
    [self.scrollView addSubview:self.stock];
    [self.stock mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.dispatchName.mas_left);
        make.top.mas_equalTo(titleLabel3.mas_bottom).with.offset(5);
        make.size.mas_equalTo(CGSizeMake(SCREEN_WIDTH-LandscapeNumber(32), 48));
    }];
    ...
    [line4 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(0);
        make.top.mas_equalTo(self.stock.mas_bottom).with.offset(10);
        make.size.mas_equalTo(CGSizeMake(SCREEN_WIDTH, 1));
    }];
    
    
    UILabel *titleLabel4 = [[UILabel alloc]init];
    titleLabel4.text = @"技术规格";
    ...
    self.spec = [[UITextField alloc]init];
    self.spec.font = [UIFont systemFontOfSize:16];
    self.spec.textColor = UIColorFromRGB(0x666666);
    self.spec.placeholder = @"请输入";
    self.spec.keyboardType = UIKeyboardTypeDefault;
    self.spec.tag = 3;
    [self.spec addTarget:self action:@selector(textFieldDidChange:) forControlEvents:UIControlEventEditingChanged];
    [self.scrollView addSubview:self.spec];
    [self.spec mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.dispatchName.mas_left);
        make.top.mas_equalTo(titleLabel4.mas_bottom).with.offset(5);
        make.size.mas_equalTo(CGSizeMake(SCREEN_WIDTH-LandscapeNumber(32), 48));
    }];
    ...
    [line5 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(0);
        make.top.mas_equalTo(self.spec.mas_bottom).with.offset(10);
        make.size.mas_equalTo(CGSizeMake(SCREEN_WIDTH, 1));
    }];
    
    
    UILabel *titleLabel5 = [[UILabel alloc]init];
    titleLabel5.text = @"产品特性与价值";
    ...
    [self.dispatchCharacteristics mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(titleLabel.mas_left);
        make.top.mas_equalTo(titleLabel5.mas_bottom).with.offset(16);
    ...
    titleLabel6.text = @"是否推荐：";
    titleLabel6.font = [UIFont systemFontOfSize:16];
    titleLabel6.textColor = UIColorFromRGB(0x3D4245);
    [self.scrollView addSubview:titleLabel6];
    [titleLabel6 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(titleLabel.mas_left);
        make.top.mas_equalTo(line6.mas_bottom).with.offset(LandscapeNumber(16));
        make.height.mas_equalTo(LandscapeNumber(17));
    }];
    ...
    [yesL mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(titleLabel6.mas_right).with.offset(10);
        make.centerY.mas_equalTo(titleLabel6.mas_centerY);
    }];
    ...
    titleLabel7.text = @"上传照片";
    titleLabel7.font = [UIFont systemFontOfSize:16];
    titleLabel7.textColor = UIColorFromRGB(0x3D4245);
    [self.scrollView addSubview:titleLabel7];
    [titleLabel7 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(titleLabel.mas_left);
        make.top.mas_equalTo(line7.mas_bottom).with.offset(LandscapeNumber(16));
        make.height.mas_equalTo(LandscapeNumber(17));
    }];
    ...
    [despLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.mas_equalTo(titleLabel7.mas_centerY);
        make.left.mas_equalTo(titleLabel7.mas_right).with.offset(8);
    }];
    ...
    [photoView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(titleLabel7.mas_bottom).with.offset(10);
    ...
    [laber mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(titleLabel7.mas_bottom).with.offset(((self.photoVC.photos.count+1)/3+1)*270 +105);
    }];
...
-(void)sendDispatchInfoToServer {
    ...
    __weak PublickPlanViewController *selfVC = self;
    
    NSString *url = [NSString stringWithFormat:@"%@v1/solution/save",DOMAIN_NAME];
    ...
    params[@"unit"] = self.cycle.text;
    params[@"stock"] = self.stock.text;
    params[@"spec"] = self.spec.text;
