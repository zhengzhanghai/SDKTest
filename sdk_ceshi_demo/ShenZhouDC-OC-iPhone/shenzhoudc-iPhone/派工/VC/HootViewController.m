...
#import "PaiModel.h"
@interface HootViewController ()
@property (nonatomic,strong) MBProgressHUD *showError;
@property (nonatomic,assign) NSInteger page;

@end

@implementation HootViewController
...
- (void)loadData{
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@?screen=3&page=%zd&size=20",DOMAIN_NAME,API_GET_ASSIGN,_page];
    NSLog(@"URL=%@",url);
