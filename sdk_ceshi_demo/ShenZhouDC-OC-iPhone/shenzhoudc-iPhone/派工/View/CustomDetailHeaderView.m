...
@interface CustomDetailHeaderView ()<SDCycleScrollViewDelegate>
...
//    if(model != nil){
//        _cycleScrollView.imageURLStringsGroup = model;
//    }
//}
- (void)setUpUi{
    ...
    SDCycleScrollView *cycleScrollView = [SDCycleScrollView cycleScrollViewWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, LandscapeNumber(234)) delegate:self placeholderImage:[UIImage imageNamed:@"详情大图默认图"]];
//    cycleScrollView.backgroundColor = [UIColor whiteColor];
    ...
    [_bottomTitleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(CGSizeMake(SCREEN_WIDTH, LandscapeNumber(42)));
    }];
