...
@interface XuQiuPingJiaViewController ()

@end

@implementation XuQiuPingJiaViewController
...
- (void)loadPingLunList:(LoadListWay)loadWay {
    NSString *url = [NSString stringWithFormat:@"%@?resourceType=%@&resourceId=%@&page=%zd&size=%d", API_GET_COMMENT,@"2", self.id, self.loadPage, LoadSize];
